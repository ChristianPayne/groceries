...
export declare function create({ appTemplate, projectDir, remixVersion, installDeps, packageManager, useTypeScript, githubToken, debug, }: {
    appTemplate: string;
    projectDir: string;
    remixVersion?: string;
    installDeps: boolean;
...
export declare function init(projectDir: string, packageManager: "npm" | "yarn" | "pnpm"): Promise<void>;
